...
public class BezierCurve extends JPanel {
    ...
    public void readObjectDescription(String fileName) {
        ...
        try {
            ...
            for (int i = 0; i < numCtrlPoints; i++) {
                ...
                int y = in.nextInt();
                int z = in.nextInt();
                //vertexArray[i] = new Point(x, y, z);
                controlPoints[i] = new Point(x, y, z);
            }
    ...
    private void drawAxis(Graphics2D g2d) {
        ...
        drawEdge(g2d,new Point(0, -100, 0), new Point(0, 100, 0));
        g2d.setColor(Color.green);
        drawEdge(g2d,new Point(-100, 0, 0), new Point(100, 0, 0));
    }
    ...
    public Point bezier(double u, int n) {
        ...
        return new Point(acumX, acumY, acumZ);
    }
